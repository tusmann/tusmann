...
var Region = function () {
  ...
  _createClass(Region, [{
    ...
    value: function overflowAmount() {
      var contentH = this.content.offsetHeight;
      var boxH = this.element.offsetHeight;
...
var isContentElement = function isContentElement(node) {
...
var shouldYield = function shouldYield() {
  var timeSinceYield = performance.now() - lastYieldTime;
  return timeSinceYield > MAX_TIME;
};

var yieldIfNecessary = function () {
  ...
  return function yieldIfNecessary() {
    return _ref.apply(this, arguments);
  };
}();

var overflowAttr = 'data-ignore-overflow';
// Walk up the tree to see if we are within
// an overflow-ignoring node
var ignoreOverflow = function ignoreOverflow(element) {
...
var addTextNode = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(textNode, parent, hasOverflowed) {
    var success;
    return regenerator.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            success = !hasOverflowed();

            if (!success) parent.removeChild(textNode);
            _context.next = 5;
            return yieldIfNecessary();
  ...
  return function addTextNode(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
var addTextNodeUntilOverflow = function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(textNode, parent, hasOverflowed) {
    var originalText, pos, fittingText, overflowingText, remainingTextNode;
    return regenerator.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            if (!(!hasOverflowed() && pos < originalText.length)) {
              _context2.next = 15;
              break;
            }
          ...
          case 21:
            ...
            // trim text to word
            fittingText = originalText.substr(0, pos);
            overflowingText = originalText.substr(pos);

            textNode.nodeValue = fittingText;

            // Create a new text node for the next flow box
            remainingTextNode = createTextNode(overflowingText);
            return _context2.abrupt('return', remainingTextNode);
  ...
  return function addTextNodeUntilOverflow(_x4, _x5, _x6) {
...
var addTextNodeAcrossParents = function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(textNode, parent, nextParent, hasOverflowed) {
    ...
    return regenerator.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return addTextNodeUntilOverflow(textNode, parent, hasOverflowed);
          ...
          case 2:
            ...
            return _context3.abrupt('return', addTextNodeAcrossParents(result, nextElement, nextParent, hasOverflowed));
  ...
  return function addTextNodeAcrossParents(_x7, _x8, _x9, _x10) {
...
// to the next page.
var tryInNextRegion = function tryInNextRegion(region, makeNextRegion, canSplit) {
  if (region.path.length <= 1) {
    throw Error('Regionize: Attempting to move the top-level element');
  }
  var startLength = region.path.length;

  // So this node won't get cloned. TODO: this is unclear
  var elementToMove = region.path.pop();

  // find the nearest splittable parent
  var nearestElementThatCanBeMoved = elementToMove;
  var pathToRestore = [];
  ...
  var parent = nearestElementThatCanBeMoved.parentNode;
  ...
  // restore subpath
  pathToRestore.forEach(function (r) {
    return nextRegion.path.push(r);
  });
...
var clonePath = function clonePath(oldPath, applyRules) {
  var newPath = [];

  var deepClone = function deepClone(el) {
    var clone = el.cloneNode(true); // deep clone, could be th > h3 > span;
    applyRules(el, clone);
    return clone;
  };

  for (var i = oldPath.length - 1; i >= 0; i -= 1) {
    var original = oldPath[i];
    var clone = original.cloneNode(false); // shallow
    var nextChild = oldPath[i + 1];
    clone.innerHTML = '';
...
var ensureImageLoaded = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(image) {
    var imgStart, failed;
    return regenerator.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            return _context.abrupt('return', performance.now() - imgStart);
  ...
  return function ensureImageLoaded(_x) {
    return _ref.apply(this, arguments);
  };
}();

var preserveNumbering = function preserveNumbering(original, clone, nextChild) {
  // restart numbering
  var prevStart = 1;
...
var preserveTableColumns = function preserveTableColumns(original, clone, nextChild, deepClone) {
  var columns = [].concat(_toConsumableArray(original.children));

  var currentIndex = columns.indexOf(nextChild);
  for (var i = 0; i < currentIndex; i += 1) {
    var clonedCol = deepClone(columns[i]);
...
// and creating boxes.
var flowIntoRegions = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5(opts) {
    var content, createRegion, applySplit, canSplit, beforeAdd, afterAdd, didWaitFor, shouldTraverse, currentRegion, hasOverflowed, canSplitCurrent, ignoreCurrentOverflow, splitRules, continueInNextRegion, continuedParent, addTextWithoutChecks, addSplittableTextNode, addWholeTextNode, canSkipTraversal, safeAddElementNode, addElementNode;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 6:
            ...
            beforeAdd = opts.beforeAdd || noop;
            afterAdd = opts.afterAdd || noop;
            didWaitFor = opts.didWaitFor || noop;
            ...
            hasOverflowed = function hasOverflowed() {
              return currentRegion.hasOverflowed();
            };

            canSplitCurrent = function canSplitCurrent() {
              return canSplit(currentRegion.currentElement);
            };

            ignoreCurrentOverflow = function ignoreCurrentOverflow() {
              return ignoreOverflow(currentRegion.currentElement);
            };

            splitRules = function splitRules(prev, clone, next, deepClone) {
            ...
            continueInNextRegion = function continueInNextRegion() {
              var oldBox = currentRegion;
              currentRegion = createRegion();

              var newPath = clonePath(oldBox.path, splitRules);
              currentRegion.setPath(newPath);
              return currentRegion;
            };

            continuedParent = function continuedParent() {
              continueInNextRegion();
              return currentRegion.currentElement;
            };

            addTextWithoutChecks = function addTextWithoutChecks(textNode, parent) {
              parent.appendChild(textNode);
            ...
            addSplittableTextNode = function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(textNode) {
                var el, hasAdded;
                return regenerator.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        el = currentRegion.currentElement;
                        _context.next = 3;
                        return addTextNodeAcrossParents(textNode, el, continuedParent, hasOverflowed);

                      case 3:
                        hasAdded = _context.sent;
              ...
              return function addSplittableTextNode(_x2) {
                return _ref2.apply(this, arguments);
              };
            }();

            addWholeTextNode = function () {
              var _ref3 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(textNode) {
                var hasAdded;
                return regenerator.wrap(function _callee2$(_context2) {
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        _context2.next = 2;
                        return addTextNode(textNode, currentRegion.currentElement, hasOverflowed);

                      case 2:
                        hasAdded = _context2.sent;
              ...
              return function addWholeTextNode(_x3) {
                return _ref3.apply(this, arguments);
              };
            }();
            ...
            canSkipTraversal = function canSkipTraversal(element) {
              var containsImage = element.querySelector('img');
              return !containsImage && !shouldTraverse(element);
            };

            safeAddElementNode = void 0;

            // Adds an element node by clearing its childNodes, then inserting them
            // one by one recursively until they overflow the region

            addElementNode = function () {
              var _ref4 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(element) {
                var childNodes, shouldSplit, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, child;
                  ...
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        ...
                        return _context3.abrupt('return', currentRegion.path.pop());

                      case 5:

                        // Clear element
                        childNodes = [].concat(_toConsumableArray(element.childNodes));
                        ...
                        shouldSplit = canSplit(element) && !ignoreOverflow(element);
                        _iteratorNormalCompletion = true;
                        _didIteratorError = false;
                        _iteratorError = undefined;
                        _context3.prev = 12;
                        _iterator = childNodes[Symbol.iterator]();
                      ...
                      case 14:
                        ...
                        _context3.next = 19;
                        return (shouldSplit ? addSplittableTextNode : addWholeTextNode)(child);
                      ...
                      case 21:
                        ...
                        _context3.next = 24;
                        return safeAddElementNode(child);
                ...
                }, _callee3, _this$3, [[12, 31, 35, 43], [36,, 38, 42]]);
              }));

              return function addElementNode(_x4) {
                return _ref4.apply(this, arguments);
              };
            }();

            safeAddElementNode = function () {
              var _ref5 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4(element) {
                var waitTime, addedElement;
                  ...
                  while (1) {
                    switch (_context4.prev = _context4.next) {
                      ...
                      case 5:
                        ...
                        _context4.next = 8;
                        return addElementNode(element);

                      case 8:
                        addedElement = _context4.sent;
              ...
              return function safeAddElementNode(_x5) {
                return _ref5.apply(this, arguments);
              };
            }();

            return _context5.abrupt('return', safeAddElementNode(content));
  ...
  return function flowIntoRegions(_x) {
    return _ref.apply(this, arguments);
  };
}();
