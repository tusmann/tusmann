...
function _parseArticle() {
  ...
  _regenerator.default.mark(function _callee(article) {
    var articleResponse, articleHtml, parser, articleDocument, body, articleURL, articlePath;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            articleURL = new URL(article, window.location.href); //get article path (without file name)
            ...
            body.querySelectorAll("img").forEach(function (image) {
              ...
              image.src = url.origin + articlePath + url.pathname;
            });
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "20961" + '/');
